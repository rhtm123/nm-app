...
const ProductListCard = ({ productListing, onPress, className = "" }) => {
  ...
  return (
    <TouchableOpacity 
      ...
      className={`flex-row bg-white rounded-xl mb-3 p-4 shadow-sm border border-gray-100 ${className}`}
      onPress={onPress} 
      activeOpacity={0.9}
    >
      {/* Product Image */}
      <View className="relative mr-4">
        <View style={{ backgroundColor: colors.gray[50] }} className="w-24 h-24 rounded-lg overflow-hidden">
          <Image
            source={{
        ...
        <DiscountBadge mrp={productListing.mrp} price={productListing.price} style={{ position: 'absolute', top: -8, left: -8 }} />
      </View>
      ...
      <View className="flex-1">
        ...
        <View className="flex-row items-center justify-between mb-2">
          <View className="flex-row items-center">
            <Text style={{ color: colors.text.primary }} className="text-lg font-bold mr-2">₹{productListing.price}</Text>
          ...
          <TouchableOpacity
            ...
            className="rounded-full p-1.5 shadow-sm border border-gray-100"
        ...
        <View className="flex-row items-center justify-between">
          <Text style={{ color: inStock ? colors.success : colors.error }} className="text-xs font-medium">
          ...
          {cartQuantity > 0 ? (
            <View className="flex-row items-center">
              ...
              {/* Quantity Display */}
              <View style={{ backgroundColor: colors.surface, borderColor: colors.primary }} className="mx-2 border rounded-lg px-3 py-1 items-center">
            ...
            <TouchableOpacity
              ...
              className="flex-row items-center justify-center px-6 py-2 rounded-lg border"
